...
export function IsoButton({ 
  ...
  return (
    <button
      onClick={onClick}
      className={`relative border-2 border-black ${bgColor} px-6 py-2 font-mono uppercase text-sm transition-all hover:translate-x-[2px] hover:translate-y-[2px] ${className}`}
      style={{
